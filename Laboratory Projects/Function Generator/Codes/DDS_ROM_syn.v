...
//altsyncram ADDRESS_ACLR_A="NONE" CLOCK_ENABLE_INPUT_A="BYPASS" CLOCK_ENABLE_OUTPUT_A="BYPASS" DEVICE_FAMILY="Cyclone IV E" ENABLE_RUNTIME_MOD="NO" INIT_FILE="sine.txt" NUMWORDS_A=256 OPERATION_MODE="ROM" OUTDATA_ACLR_A="NONE" OUTDATA_REG_A="UNREGISTERED" WIDTH_A=8 WIDTH_BYTEENA_A=1 WIDTHAD_A=8 address_a clock0 q_a
...
`endif
	...
	defparam
		...
		ram_block1a_0.init_file = "sine.txt",
	...
	defparam
		...
		ram_block1a_1.init_file = "sine.txt",
	...
	defparam
		...
		ram_block1a_2.init_file = "sine.txt",
	...
	defparam
		...
		ram_block1a_3.init_file = "sine.txt",
	...
	defparam
		...
		ram_block1a_4.init_file = "sine.txt",
	...
	defparam
		...
		ram_block1a_5.init_file = "sine.txt",
	...
	defparam
		...
		ram_block1a_6.init_file = "sine.txt",
	...
	defparam
		...
		ram_block1a_7.init_file = "sine.txt",
	...
	initial/*synthesis enable_verilog_initial_construct*/
 	begin
		$display("Warning: Memory initialization file sine.txt doesnt belong to any of the three recognized file types (MIF, RIF or HEX). Assuming file type to be MIF.");
	end
endmodule //DDS_ROM_altsyncram
//VALID FILE
...
`endif
	...
	DDS_ROM_altsyncram	DDS_ROM_altsyncram_component (
				.address_a (address),
				.clock0 (clock),
				.q_a (sub_wire0));
